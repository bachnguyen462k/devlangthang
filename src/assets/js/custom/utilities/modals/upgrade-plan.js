...
var KTModalUpgradePlan = function() {
    ...
    return {
        init: function() {
            (t = document.querySelector("#kt_modal_upgrade_plan")) && (n = t.querySelector('[data-kt-plan="month"]'), e = t.querySelector('[data-kt-plan="annual"]'), a = document.querySelector("#kt_modal_upgrade_plan_btn"), n.addEventListener("click", (function(t) {
                t.preventDefault(), n.classList.add("active"), e.classList.remove("active"), i("month")
            })), e.addEventListener("click", (function(t) {
                t.preventDefault(), n.classList.remove("active"), e.classList.add("active"), i("annual")
                ...
                swal.fire({
                    ...
                    n.isConfirmed && (e.setAttribute("data-kt-indicator", "on"), e.disabled = !0, setTimeout((function() {
                        Swal.fire({
