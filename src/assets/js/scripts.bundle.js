...
var KTLayoutAside = function() {
    ...
    return {
        init: function() {
            (e = document.querySelector("#kt_aside_categories_toggle")) && e.addEventListener("click", (function(e) {
                e.preventDefault(), "Thu gọn" === this.innerHTML ? this.innerHTML = "Xem Thêm" : this.innerHTML = "Thu gọn"
            }))
        }
    }
}();
...
var KTLayoutSidebar = {
    init: function() {
        var e;
        (e = document.querySelector("#kt_sidebar_search_form")) && e.querySelector(".form-control").addEventListener("keyup", (function(t) {
